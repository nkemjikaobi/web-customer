      ...
      <div className={styles.contentWrapper}>
          ...
          {clicked === 1 ? (
            <div className={styles.dropdown}>
              <p className={styles.textTop}>
                Just like transacting on kongaPay, registration is easy. We
                understand the peculiarities of our customers, so we have
                reviewed our registration process to be easier. Customers can
                operate on different levels and the requirements for each level
                is as follows;
              </p>
              <p className={styles.listWrapper}>KongaPay Lite: </p>
              <ul>
                <li>Name</li>
                <li>Email Address</li>
              ...
              <p className={styles.listWrapper}> KongaPay Classic: </p>
              <ul>
                <li>Image Upload</li>
                <li>BVN</li>
                <li>Valid Means of Identification</li>
              </ul>
              <p className={styles.listWrapper}>KongaPay Premium:</p>
              <ul>
                <li>Address Verification or Utility bill.</li>
              </ul>
              To get started, simply follow the steps below; First, download the
              app on the Google play or App store. If you do not own an Android
              or Apple device, you can still sign up by visiting the website,
              kongapay.com to sign up.
            </div>
          ) : null}
        </div>
        {/**Content 3 */}
        <div className={styles.content} onClick={() => toggle(2)}>
          <div className={styles.titleWrapperWhite}>
            <div>
              <p className={clicked === 2 ? styles.redTitle : styles.title}>
                How do I link my card to my Kongapay account?
              </p>
            </div>
            <div className={styles.arrow}>
              {clicked === 2 ? (
          ...
          {clicked === 2 ? (
            <div className={styles.dropdown}>
              <p className={styles.textTop}>
                Kindly follow the steps below to link your card to your account
              </p>
              <ul>
                <li>
                  Login to your KongaPay account with your telephone number and
                  unique 4 digit security PIN.
                </li>
                <li>
          ...
          <div className={styles.titleWrapperWhite}>
            <div>
              <p className={clicked === 4 ? styles.redTitle : styles.title}>
                Yes, you can and it’s easy. Follow the steps below:
              </p>
            </div>
            <div className={styles.arrow}>
              {clicked === 4 ? (
        ...
        <div className={styles.content} onClick={() => toggle(10)}>
          ...
          {clicked === 10 ? (
            <div className={styles.dropdown}>
              ...
              support@kongapay.com authorizing us to block your account as soon
              as possible.
            </div>
          ) : null}
        </div>
