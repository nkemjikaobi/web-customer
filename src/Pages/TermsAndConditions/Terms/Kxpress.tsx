...
const Kexpress: React.FunctionComponent<IProps> = ({ sectionData }) => {
  ...
  const contents =
    sectionData &&
    isNotEmptyArray(sectionData.kongaXpressTermsAndConditions) &&
    sectionData.kongaXpressTermsAndConditions[0].content[0].data;
